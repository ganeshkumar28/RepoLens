...
// Service that handles the OAuth2 user information received from GitHub and updates or creates a corresponding User entity in the database
public class GithubOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    // Implementation of the service that loads user details from GitHub
